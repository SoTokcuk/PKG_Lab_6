...
//
    ...
    VertexArray[12][0]=0;
    VertexArray[12][1]=2*k;
    VertexArray[12][2]=0;

    VertexArray[13][0]=0;
    VertexArray[13][1]=2*k;
    VertexArray[13][2]=-0.25*k;
    ...
    VertexArray[16][0]=0;
    VertexArray[16][1]=2*k;
    VertexArray[16][2]=0;

    VertexArray[17][0]=0.25*k;
    VertexArray[17][1]=2*k;
    VertexArray[17][2]=0;
